...
config/Boss.cpp               IA de la ligue — solver C++ negamax alpha-beta
config/levelN/Boss.cpp        boss par ligue (copie tunable du solver)
config/Boss.java.archive      ancien boss Java naif (conservé pour référence)
